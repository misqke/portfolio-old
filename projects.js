const projects = [
  {
    ...
    about: [
      "This project was inspired by my girlfriends delapitated recipe book.  This was my first full stack project and helped me learn node, express, and mongoose.",
  ...
  },
  {
    ...
    about: [
      "Anyone whos run a Dungeons and Dragons game knows balancing encounters can be a real pain.  The guides provided require a number or tables and random calculations, enough to make your head spin.  Enter the encounter buddy to do all that confusing work for you.",
      "The first step of this project involved building a web scraper with Puppeteer to build the monster data base. Next came an api full of complicated logic to generate the desired encounter. Finally, a nice polished interface to display it all in.",
    ],
  ...
  },
  {
    ...
    about: [
      "While learning to code i worked in the dairy department of a grocery store.  Our milk inventory and orders involved printing and order form, counting all the milk on the shelf, counting all the crates in the cooler, mathing it all together, then entering all this data on the computer to submit.",
      "The Milk Master 9000 has cut the time of this process by 75%.  Simply log in on your phone, enter the milk on the shelves and the number of crates and hit submit.  All the math is handled and a Puppeteer webscraper on the server side navigates the milk companies website, fills out and submits the form, and sends you back a screen shot of the confirmation.",
    ],
  ...
  },
  {
    ...
    about: [
      ...
      "This project was my first work with intersection observers and taught me a great deal for working with animation and layout.",
    ],
